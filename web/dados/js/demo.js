...
$(function () {
    ...
    function get(name) {
        if (typeof (Storage) !== 'undefined') {
            ...
            var cls = localStorage.getItem(name);
            return (cls == null) ? 'skin-green' : cls;
        } else
            return 'skin-green';
    }
    ...
    function store(name, val) {
        if (typeof (Storage) !== 'undefined') {
            ...
            window.alert('Seu navegador não suporta este recurso!')
        }
    }
    ...
    $demoSettings.append('<h4 class="control-sidebar-heading">Personalizar</h4>')
    $demoSettings.append($skinsList)

    $tabPane.append($demoSettings)
    $('#sel_cores').append($tabPane)
