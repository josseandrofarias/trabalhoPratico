         ...
         <div class="content-wrapper" style="min-height: 717px;">
            ...
            <div class="container-fluid">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="tabelaFunc">
                        <thead>
                            <tr>
                                <th scope="col">ID</th>
                           ...
                           // echo $sqlEditar;
                            while($registro = mysqli_fetch_assoc($resultado)){
                                echo '<tr>';
                                        ...
                                        echo "  
                                        <td><button type='button' class='btn btn-primary' data-toggle='modal' data-target='#telaEditarFunc" .$registro["id"]. "'><i class='fas fa-pen'></i></button>
                                        <button type='button' class='btn btn-danger' data-toggle='modal' data-target='#telaExcluirFunc" .$registro["id"]. "'><i class='fas fa-trash-alt'></i></i></button></td>
                                        ";
                                    echo '</tr>';
                                }
                             ?>
                ...
                <?php foreach($resultado as $aqui){ ?>
                        <!-- Modal editar -->
                        <div id="telaEditarFunc<?php echo $aqui['id']?>" class="modal fade" role="dialog">
                            <?php
                            //pegando informacoes do carro de acordo com o id
                            $sqlEditar = 'SELECT * FROM funcio where id= '.$aqui['id'];
                                        ...
                                        <form role="form" method="post" action="cad_funcionario.php" data-toggle="validator">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input name="Nome" type="text" class="form-control" id="Nome" value="<?php echo $aqui['nome']?>" id="Nome" data-error="Insira o nome do funcionário." required>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input name="cargo" type="text" class="form-control" id="seguroVeiculo" value="<?php echo $aqui['cargo'];?>" data-error="Insira o cargo" required>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="dataAdmissao">Admissão:</label>
                                                    <input name="dataAdmissao" type="date" class="form-control" id="dataAdmissao" value="<?php echo $aqui['dataAdmissao'];?>"
                                                    <div class="help-block with-errors">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="dataDemissao">Demissão:</label>
                                                    <input name="dataDemissao" type="date" class="form-control" id="dataDemissao" value="<?php echo $aqui['dataAdmissao'];?>"
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                                <div>
                                                    <br>
                                                        <input type="checkbox" name="deativado" id="deativado"> Ativo
                                                    <br>
                                                </div>
                                                <div>
                                                    <br>
                                                        <input type="checkbox" name="supervisor" id="supervisor"> Supervisor
                                                    <br>
                                                </div>
                                                </div>
                    ...
                    <!-- modal excluir -->
                    <?php foreach($resultado as $aqui){ ?>
                        <div class="modal fade" id="telaExcluirFunc<?php echo $aqui['id']?>" role="dialog">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content" data-backdrop="static">
                                        <form action="cad_funcionario.php" data-toggle="validator" method="post">
                                            <div class="modal-header">
                                                <h3 class="modal-title">Cadastrando funcionários</h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
